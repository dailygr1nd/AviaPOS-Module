...
ACTIVE_IMPORTS = [
    ...
    "modules.purchases.api",
    "modules.purchases.commands",
    "modules.purchases.command_handlers",
    "modules.purchases.models",
    "modules.purchases.projector",
    "modules.purchases.query_service",
    "modules.purchases.reactions",
